...
public class MetaCogActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        Collections.addAll(textattrib,"help others","digs in","goes out","has a dog","monopoliser","aloner","'49 player","scrounger","athlete","rounded");
    ...
    public void onGoClick(View view){
        ...
        int num = 0;
        String out = String.format(Locale.ENGLISH,"%d",num);
