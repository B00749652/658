INSERT INTO Domain (domainID, domain, greeting, farewell)
VALUES(1, 'Alternative','What''s new?','au revoir'),
...
(7, 'Urgent','What''s up Doc?','Safe home');

INSERT INTO Attributes(userID, mobility, cognition, company, sex)
VALUES('ROOT','TRUE','HAPPY','SOLO','MALE');

INSERT INTO Content(contentID, domainID, content)
VALUES(0,'Lifestyle','Bringing the outdoors in is a key philosophy of Hygge'),
